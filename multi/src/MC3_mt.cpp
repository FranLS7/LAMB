...
int main (int argc, char **argv){
  ...
  if (argc != 7){
    cout << "Execution: " << argv[0] << " max_size jump_size iterations nthreads cube_file output_files" << endl;
    return (-1);
  } else {
    ...
    cube_filename.append(argv[5]);
    out_file0.append(argv[6]); out_file0.append("0.csv");
    out_file1.append(argv[6]); out_file1.append("1.csv");
  }
